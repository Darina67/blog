...
<html lang="ru">
  ...
  <body>
    <div class="page" id="page">
      ...
      <main class="main">
        <div class="container">
<h1 class="page__title page__title--center">Редактирование поста</h1>

<form action="vendor/updatepost.php" class="form form--auth" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?= $post['id']?>">
  <div class="form__group form__group--md">
    <input type="text" name="title" class="form__control" placeholder="Название" value="<?= $post['title']?>" />
  ...
  <div class="form__group form__group--md">
<!--    <input type="text" name="category" value="--><?//= $post['category']?><!--" class="form__control" placeholder="Категория" />-->
      <select name="category" id="category" class="form__control">
          <option value="Создание сайтов" <?= ($post['category'] == 'Создание сайтов')? 'selected' : ''?>>Создание сайтов</option>
          <option value="Интернет маркетинг" <?= ($post['category'] == 'Интернет маркетинг')? 'selected' : ''?>>Интернет маркетинг</option>
          <option value="Продвижение видео" <?= ($post['category'] == 'Продвижение видео')? 'selected' : ''?>>Продвижение видео</option>
          <!--Новый пункт-->
          <option value="Интересное" <?= ($post['category'] == 'Интересное')? 'selected' : ''?>>Интересное</option>
      </select>
    <span class="form__line"></span>
  </div>
    <img
